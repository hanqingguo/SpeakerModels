...
# Given a sentence, output the d-vector of the sentences
...
model_file = '/home/hanqing/1ASpeakerRecognition/SincNet/exp/SincNet_highbadData/model_raw.pkl'  # This is the model to use for computing the d-vectors (it should be pre-trained using the speaker-id DNN)
cfg_file = '/home/hanqing/1ASpeakerRecognition/SincNet/cfg/SincNet_highbad.cfg'  # Config file of the speaker-id experiment used to generate the model
# convert which speakers to d_vector?
# enroll_lowbad.scp
# Or
# verify_highbad.scp
te_lst = '/home/hanqing/1ASpeakerRecognition/SincNet/highbadEnroll/verify_highbad.scp'  # List of the wav files to process
out_dict_file = './d_vectors/d_vect_highbad_verify.npy'  # output dictionary containing the a sentence id as key as the d-vector as value
